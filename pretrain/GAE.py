...
class IGAE_encoder(nn.Module):
    ...
    def forward(self, x, adj):
        ...
        z_igae = self.gnn_4(z, adj, active=False)
...
class IGAE_decoder(nn.Module):
    ...
    def forward(self, z_igae, adj):
        z = self.gnn_5(z_igae, adj, active=True)
        z = self.gnn_6(z, adj, active=True)
        z = self.gnn_7(z, adj, active=True)
        z_hat = self.gnn_8(z, adj, active=True)
